// @ts-ignore
import { photosPortraitBrandon, photosPortraitEwa, photosPortraitJennifer } from 'assets/images'
...
const cardsAgile: Question[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        number: 'B',
        question: 'Do all of the development work, except for specialized testing that requires additional tools and environments',
        value: false,
        revealed: false,
        picked: false
      },
      {
        number: 'C',
        question: 'Turn the Product Backlog items it selects into an increment of potentially releasable product functionality',
        value: false,
        revealed: false,
        picked: false
      }
