...
const QuizListElement: React.FC<Props> = ({ onPress, authorName, imageSource, mainText, labelText, elements, pressUser }) => (
    ...
    <View style={styles.authorWrapper}>
      <TouchableOpacity style={styles.authorContainer} onPress={pressUser}>
        <View style={styles.footerContainer}>
          {imageSource && <Image source={imageSource} style={styles.authorPhoto} resizeMode="contain" />}
