...
const QuizOption: React.FC<Props> = ({ reveal, revealed, card: { number, question, value } }) => {
  ...
  if (revealed) {
    ...
    return (
      <View style={[styles.container, { backgroundColor, width: windowWidth * QUIZ_OPTION_WIDTH_PERCENTAGE }]}>
  ...
  return (
    <TouchableOpacity onPress={onPress} style={[styles.container, { width: windowWidth * QUIZ_OPTION_WIDTH_PERCENTAGE }]}>
      <View style={[styles.letterContainer, { paddingVertical }]}>
